...
function pieceBase() {
  return `
    <ellipse class="piece-shadow" cx="50" cy="91" rx="33" ry="5.8"></ellipse>
    <path class="piece-fill piece-base" d="M22 84 C27 78 73 78 78 84 L75 93 H25 Z"></path>
    <path class="piece-rim" d="M28 84 H72"></path>
    <path class="piece-rim soft" d="M31 89 H69"></path>
  `;
}
...
function pieceSvg(type) {
  ...
  const bodies = {
    p: `
      <circle class="piece-fill piece-head" cx="50" cy="24" r="12.5"></circle>
      <path class="piece-highlight" d="M45 18 C48 15 54 15 57 19"></path>
      <path class="piece-fill" d="M40 39 C40 33 60 33 60 39 C60 45 56 49 54 54 C60 59 64 67 66 77 H34 C36 67 40 59 46 54 C44 49 40 45 40 39 Z"></path>
      <path class="piece-rim" d="M39 52 H61"></path>
      <path class="piece-rim" d="M36 76 H64"></path>
      ${base}
    `,
    r: `
      <path class="piece-fill" d="M28 17 H39 V27 H45 V17 H55 V27 H61 V17 H72 V38 H28 Z"></path>
      <path class="piece-rim" d="M31 38 H69"></path>
      <path class="piece-fill" d="M38 40 H62 L66 77 H34 Z"></path>
      <path class="piece-highlight" d="M42 45 C46 43 54 43 58 45"></path>
      <path class="piece-rim" d="M37 68 H63"></path>
      <path class="piece-rim" d="M35 77 H65"></path>
      ${base}
    `,
    n: `
      <path class="piece-fill" d="M31 78 C34 63 38 52 45 45 C39 38 39 27 48 16 C52 23 61 25 67 31 C75 39 75 52 66 61 C61 66 55 69 50 72 L67 78 Z"></path>
      <path class="piece-detail" d="M47 24 C56 29 62 34 65 42"></path>
      <path class="piece-detail" d="M44 45 C50 49 56 50 63 48"></path>
      <path class="piece-detail" d="M39 60 C47 66 56 68 64 67"></path>
      <circle class="piece-dot" cx="55" cy="34" r="2.4"></circle>
      <path class="piece-rim" d="M34 78 H68"></path>
      ${base}
    `,
    b: `
      <path class="piece-fill" d="M50 12 C64 22 69 36 62 48 C59 53 55 56 51 59 C62 63 66 70 67 78 H33 C34 70 38 63 49 59 C45 56 41 53 38 48 C31 36 36 22 50 12 Z"></path>
      <path class="piece-detail" d="M56 27 L43 50"></path>
      <path class="piece-highlight" d="M43 23 C47 18 53 18 57 23"></path>
      <circle class="piece-dot" cx="50" cy="18" r="2.6"></circle>
      <path class="piece-rim" d="M36 78 H64"></path>
      ${base}
    `,
    q: `
      <circle class="piece-fill" cx="27" cy="25" r="5.6"></circle>
      <circle class="piece-fill" cx="39" cy="17" r="5.8"></circle>
      <circle class="piece-fill" cx="50" cy="13" r="6.2"></circle>
      <circle class="piece-fill" cx="61" cy="17" r="5.8"></circle>
      <circle class="piece-fill" cx="73" cy="25" r="5.6"></circle>
      <path class="piece-fill" d="M24 34 L36 42 L43 27 L50 45 L57 27 L64 42 L76 34 L68 59 H32 Z"></path>
      <path class="piece-highlight" d="M35 46 C43 50 57 50 65 46"></path>
      <path class="piece-fill" d="M38 60 H62 C66 66 68 72 67 78 H33 C32 72 34 66 38 60 Z"></path>
      <path class="piece-rim" d="M34 60 H66"></path>
      <path class="piece-rim" d="M36 78 H64"></path>
      ${base}
    `,
    k: `
      <path class="piece-detail cross" d="M50 8 V28"></path>
      <path class="piece-detail cross" d="M41 17 H59"></path>
      <path class="piece-fill" d="M38 32 C38 22 62 22 62 32 C62 39 57 44 50 48 C43 44 38 39 38 32 Z"></path>
      <path class="piece-highlight" d="M43 31 C46 27 54 27 57 31"></path>
      <path class="piece-fill" d="M35 49 H65 C70 58 69 69 63 78 H37 C31 69 30 58 35 49 Z"></path>
  ...
  return `<svg class="piece-svg staunton-svg" viewBox="0 0 100 100" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg">${bodies[type] || ""}</svg>`;
}
...
function initPlayPage(user) {
  ...
  function renderBoard() {
    ...
    const checkedKingSquare = chess.in_check() ? getKingSquare(chess.turn()) : "";
    ...
    getSquares().forEach((squareName) => {
      ...
      setText("status", "Brettet støtte på en visningsfeil. Prøv å oppdatere siden.");
    }
  }
