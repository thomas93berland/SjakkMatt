...
window.CHESS_LOUNGE_APP_V20_MODULE_RUNNING = true;
console.log("Chess Lounge app-v20 module running");
...
function initPlayPage(user) {
  ...
  function setupPieceTheme() {
    const select = $("pieceThemeSelect");
    const themes = ["lounge", "wood", "gold", "minimal"];
    const storageKey = "chessLoungePieceTheme";

    function applyTheme(value) {
      const theme = themes.includes(value) ? value : "lounge";
      ...
      document.body.classList.add("piece-theme-" + theme);
    ...
    applyTheme(localStorage.getItem(storageKey) || "lounge");
